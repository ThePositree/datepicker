class Datepicker {
  constructor($el, $el2, { date = new Date(), date2 = new Date(), inputTwo = false }) {
      ...
      if (!e.target.classList.contains('dp-btn-inner') && !e.target.classList.contains('dp-btn-inner2')) {
        if (!e.target.classList.contains('dp-btn-year') && !e.target.classList.contains('dp-btn-year2')) {
          if (!e.target.classList.contains('dp-btn-mounth') && !e.target.classList.contains('dp-btn-mounth2')) {
            if (myDp.classList.contains('dp-container--active') && myDp2.classList.contains('dp-container--active2')) {
              if (!e.target.closest(`.${$el.parentNode.classList[0]}`) && !e.target.closest(`.${$el2.parentNode.classList[0]}`)) {
                myDp.classList.remove('dp-container--active')
              }
            }
          }
...
const asdfadsf = new Datepicker(asdf, asdf2, {
  date: '2003-02-20',
  date2: '2003-03-20',
})